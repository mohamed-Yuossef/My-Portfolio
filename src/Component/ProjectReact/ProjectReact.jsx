...
import PH from "/src/assets/category-valves.jpg";
    ...
    <>
      <div className="my-32 lg:my-10">
        <div className="grid lg:grid-cols-9 md:grid-cols-6 lg:gap-5 gap-10 items-center justify-center">
          <div className=" port col-span-3 p-5  bg-white border-gray-200 rounded-lg shadow-lg ">
            <motion.div
