    ...
    <>
      <div className="my-32 lg:my-10">
        <div className="grid lg:grid-cols-9 md:grid-cols-6 lg:gap-5 gap-10 items-center justify-center">
          <div className="port min-hover  col-span-3 max-w-xs rounded-lg">
            <motion.div
              ...
              //
            >
              <div className="border border-slate-600 rounded-md p-1">
                ...
                <div className=" my-2 h-[130px]">
                  ...
                  <p className="mb-3 font-normal text-gray-500 dark:text-gray-300">
                    A website is a system for creating an account and logging in
                    through it to reach the welcome page
                  </p>
                </div>
              </div>
          ...
          <div className="port min-hover p-5 col-span-3 max-w-xs rounded-lg  ">
            <motion.div
              initial={{ opacity: 0, scale: 0.5 }}
              animate={{ opacity: 1, scale: 1 }}
              transition={{
            ...
            >
              <div className="border border-slate-600 rounded-md p-1">
                ...
                <div className="my-2 h-[130px] ">
                  ...
                  <p className="mb-3 font-normal text-gray-500 dark:text-gray-300">
                    ُ Egyptian Party Let's Have Fun
                  </p>
                </div>
              </div>
              <div className="flex justify-between items-center border border-slate-600 rounded-md mt-1 p-1">
            ...
            >
              <div className="border border-slate-600 rounded-md p-1">
                ...
                <div className="my-2 h-[130px] ">
                  ...
                  <p className="mb-3 font-normal text-gray-500 dark:text-gray-300">
                    A website for adding products including name, category,
            ...
            >
              <div className="border border-slate-600 rounded-md p-1">
                ...
                <div className="my-2 h-[130px] ">
                  ...
                  <p className="mb-3 font-normal text-gray-500 dark:text-gray-300">
                    A website to display the games
                  </p>
                </div>
              </div>
              <div className="flex justify-between items-center border border-slate-600 rounded-md mt-1 p-1">
          ...
          <div className="port min-hover p-5 col-span-3 max-w-xs rounded-lg shadow dark:bg-gray-800 ">
            <motion.div
              initial={{ opacity: 0, scale: 0.5 }}
              animate={{ opacity: 1, scale: 1 }}
              transition={{
            ...
            >
              <div className="border border-slate-600 rounded-md p-1">
                ...
                <div className="my-2 h-[130px] ">
                  ...
                  <p className="mb-3 font-normal text-gray-500 dark:text-gray-300">
                    A website to determine the weather for 3 days by specifying
                    your location and the country in which you are located
                  </p>
                </div>
              </div>
              <div className="flex justify-between items-center border border-slate-600 rounded-md mt-1 p-1">
            ...
            >
              <div className="border border-slate-600 rounded-md p-1">
                ...
                <div className="my-2 h-[130px] ">
                  ...
                  <p className="mb-3 font-normal text-gray-500 dark:text-gray-300">
                    A website for all types of foods and how to prepare them in
            ...
            >
              <div className="border border-slate-600 rounded-md p-1">
                ...
                <div className="my-2 h-[130px] ">
                  ...
                  <p className="mb-3 font-normal text-gray-500 dark:text-gray-300">
                    A website for adding any website that have a name and link ,
                    I can delete any website or make any view link of website
                  </p>
                </div>
              </div>
              <div className="flex justify-between items-center border border-slate-600 rounded-md mt-1 p-1">
