  ...
  return (
    <>
      <div className="my-32 lg:my-10">
        ...
        >
          <div className="grid lg:grid-cols-9 md:grid-cols-6 lg:gap-5 gap-y-10 items-center">
            <div className=" port min-hover p-1 col-span-3 gap-3 hover max-w-xs rounded-lg shadow ">
              <div className="">
